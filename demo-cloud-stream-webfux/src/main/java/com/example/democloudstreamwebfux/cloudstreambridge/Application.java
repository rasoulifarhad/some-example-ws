...
public class Application {
    ...
    public static void main(String[] args) throws Exception {
        ...
        new SpringApplicationBuilder()
                ...
                .properties("spring.config.name=cloudstreambridge")
                .properties("spring.config.location=optional:classpath:com/example/democloudstreamwebfux/cloudstreambridge/")
